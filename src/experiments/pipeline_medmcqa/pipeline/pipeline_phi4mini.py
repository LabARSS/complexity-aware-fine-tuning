...
if __name__ == "__main__":
    ...
    cfg.save_dir = str(Path(__file__).parent.joinpath("../../../../artifacts/pipeline_medmcqa/pipeline/phi4"))
    cfg.train_path = str(
        Path(__file__).parent.joinpath("../../../../data/data_splits/entropy/phi/medmcqa_train_hard.jsonl")
    )
